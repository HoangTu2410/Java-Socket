...
public class ServerMainFrm extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Server UDP Game Mario");
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        ...
        if(!txtServerPort.getText().isEmpty() && (txtServerPort.getText().trim().length() > 0)) {//custom port
            ...
            myServer = new ServerUDPCtr(this, port);
        }else {// default port
            myServer = new ServerUDPCtr(this);
        }
        if(myServer.open()){
